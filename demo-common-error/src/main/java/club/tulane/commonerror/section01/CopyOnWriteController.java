...
public class CopyOnWriteController {
    ...
    public Map testWrite() {
        ...
        IntStream.rangeClosed(1, loopCount).parallel().forEach(value -> synchronizedList.add(ThreadLocalRandom.current().nextInt(loopCount)));
        stopWatch.stop();
    ...
    public Map testRead() {
        ...
        stopWatch.start("Read:synchronizedList"); //循环1000000次并发从加锁的ArrayList随机查询元素
